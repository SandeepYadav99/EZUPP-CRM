    ...
    <ShadowBox className={styles.paper}>
      <div className={styles.headerAlign}>
        ...
        <div className={styles.alignDataValue}>
          <Typography
            variant={"subtitle2"}
            onClick={() => setIndexData(0)}
            className={`${indexData === 0 && styles.underLine}`}
          >
            {" "}
            Today
          </Typography>
          <Typography
            variant={"subtitle2"}
            onClick={() => setIndexData(1)}
            className={`${indexData === 1 && styles.underLine}`}
          >
            {" "}
            Week{" "}
          </Typography>
          <Typography
            variant={"subtitle2"}
            onClick={() => setIndexData(2)}
            className={`${indexData === 2 && styles.underLine}`}
          >
            {" "}
            Month
          </Typography>
          <Typography
            variant={"subtitle2"}
            onClick={() => setIndexData(3)}
            className={`${indexData === 3 && styles.underLine}`}
          >
            {" "}
            Year
          </Typography>
