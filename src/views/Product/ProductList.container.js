    ...
    const tableStructure = [
      ...
      },
      {
        ...
        render: (temp, all) => (
          <div className={styles.industry}>
            {all.industry}
            <br />
            <div>Prescription Medicine | Pharmacy</div>
          </div>
        ),
      },
      {
      ...
      },
      {
        ...
        render: (temp, all) => (
          <div>
            <b>
              {Constants.CURRENCY} {all.min_price}
            </b>{" "}
            / KG <br />
            <span style={{ fontSize: "0.7rem" }}> 200 KG</span>
          </div>
        ),
      },
      {
        ...
        render: (temp, all) => (
          <div>
            <IconButton
              ...
              onClick={this._handleViewProductForm.bind(this, all)}
            >
