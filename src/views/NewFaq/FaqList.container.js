...
class UpdatedFaqList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dialogState: false,
  ...
  _handleViewPage() {
    window.open("http://91.205.173.97:2475/contact", "_blank");
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <CustomListHeader
          title={"VIEW PAGE"}
          handleCreate={this._handleViewPage}
          sideTitlle={"FREQUENTLY ASKED QUESTIONS"}
        />
        {/* <Button
        ...
        <div className={styles.outerFlex}>
          ...
          <div className={styles.right}>
            <QuestionView category={selectedCategory} />
          </div>
        </div>
      </div>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdatedFaqList);
