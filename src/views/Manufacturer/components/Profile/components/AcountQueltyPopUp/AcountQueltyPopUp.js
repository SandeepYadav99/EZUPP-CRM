...
import styles from './AcountQueltyPopup.css'
...
class AccountQualityDialog extends Component{
    constructor(props){
        super(props);
        this.state={
            users: [],
        ...
        return(
            <div className={styles.formContainer}>
                <form onSubmit={handleSubmit(this._handleSubmit)}>
                    ...
                    <div className={styles.submitBtn} style={{textAlign:"center", marginBottom:"10px"}}>
