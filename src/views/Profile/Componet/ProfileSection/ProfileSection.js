    ...
    <ShadowBox width={"100%"}>
      <div >
        <div className={styles.profileContainer}>
          ...
          <div>
            <Typography   variant="h4" color={theme.palette.text.primary} fontWeight={600} className={styles.profileTitle} sx={{
              whiteSpace: 'nowrap',
              overflow: 'hidden',
            ...
            <Typography variant="body1"  color={theme?.palette.text.secondary} fontWeight={600}  sx={{
              whiteSpace: 'nowrap',
              overflow: 'hidden',
              textOverflow: 'ellipsis',
              wordSpacing:"0", 
        ...
        <Typography  marginTop={3} fontWeight={600} variant="h4" color={theme.palette.text.primary} >Personal Details</Typography>
        ...
        <Typography  marginTop={3} fontWeight={600} variant="h4" color={theme.palette.text.primary}  >Work Details</Typography>
        <div className={styles.gaps} />
        <div>
